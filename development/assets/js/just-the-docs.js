...
function initSearch() {
  ...
  request.open('GET', '/hf-alicat-basis2-driver/development/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/hf-alicat-basis2-driver/development/assets/css/just-the-docs-' + theme + '.css');
}
